...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRight::initReverseAnimateWindow( AnimWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRight::initAnimateWindow( AnimWindow *animWin )
{
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSlideFromRight::updateAnimateWindow( AnimWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromRight::reverseAnimateWindow( AnimWindow *animWin )
{
...
void ProcessAnimateWindowSlideFromLeft::initReverseAnimateWindow( AnimWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromLeft::initAnimateWindow( AnimWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromLeft::updateAnimateWindow( AnimWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromLeft::reverseAnimateWindow( AnimWindow *animWin )
{
...
void ProcessAnimateWindowSlideFromTop::initReverseAnimateWindow( AnimWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromTop::initAnimateWindow( AnimWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromTop::updateAnimateWindow( AnimWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromTop::reverseAnimateWindow( AnimWindow *animWin )
{
...
void ProcessAnimateWindowSlideFromBottom::initReverseAnimateWindow( AnimWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromBottom::initAnimateWindow( AnimWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromBottom::updateAnimateWindow( AnimWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromBottom::reverseAnimateWindow( AnimWindow *animWin )
{
...
void ProcessAnimateWindowSlideFromBottomTimed::initReverseAnimateWindow( AnimWindow *animWin, UnsignedInt maxDelay )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
void ProcessAnimateWindowSlideFromBottomTimed::initAnimateWindow( AnimWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromBottomTimed::updateAnimateWindow( AnimWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromBottomTimed::reverseAnimateWindow( AnimWindow *animWin )
{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSpiral::initReverseAnimateWindow( AnimWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSpiral::initAnimateWindow( AnimWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSpiral::updateAnimateWindow( AnimWindow *animWin )
{
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSpiral::reverseAnimateWindow( AnimWindow *animWin )
{
...
void ProcessAnimateWindowSlideFromTopFast::initReverseAnimateWindow( AnimWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromTopFast::initAnimateWindow( AnimWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromTopFast::updateAnimateWindow( AnimWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromTopFast::reverseAnimateWindow( AnimWindow *animWin )
{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRightFast::initReverseAnimateWindow( AnimWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRightFast::initAnimateWindow( AnimWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D size = {0,0};
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSlideFromRightFast::updateAnimateWindow( AnimWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromRightFast::reverseAnimateWindow( AnimWindow *animWin )
{
