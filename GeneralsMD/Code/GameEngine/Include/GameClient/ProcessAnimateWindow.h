...
//						Then setup each of the virtual classes to process an AnimWindow
...
public:
	...
	virtual void initAnimateWindow( AnimWindow *animWin ) = 0;
	virtual void initReverseAnimateWindow( AnimWindow *animWin, UnsignedInt maxDelay = 0 ) = 0;
	virtual Bool updateAnimateWindow( AnimWindow *animWin ) = 0;
	virtual Bool reverseAnimateWindow( AnimWindow *animWin ) = 0;
...
public:
	...
	virtual void initAnimateWindow( AnimWindow *animWin );
	virtual void initReverseAnimateWindow( AnimWindow *animWin, UnsignedInt maxDelay = 0 );
	virtual Bool updateAnimateWindow( AnimWindow *animWin );
	virtual Bool reverseAnimateWindow( AnimWindow *animWin );
private:
