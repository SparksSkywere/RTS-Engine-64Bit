...
/*						if (flipForBlend)
		...
		D3D9_SetVertexShader(m_pDev, SHADOW_VOLUME_FVF);
...
*/
	...
	D3D9_SetVertexShader(m_pDev, SHADOW_DECAL_FVF);
...
//m_pDev->SetRenderState( D3DRS_ALPHABLENDENABLE, FALSE );	//useful to see bounds
	...
	if (DX8Wrapper::_Is_Triangle_Draw_Enabled())
	{
		...
		m_pDev->DrawIndexedPrimitive(D3DPT_TRIANGLELIST,0,0,nShadowDecalVertsInBatch,nShadowDecalStartBatchIndex,nShadowDecalPolysInBatch);
	}
